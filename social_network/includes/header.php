...
?>
<nav class="navbar">
	<div class="container-fluid"; style="background-color: whitesmoke;  padding: 5px ">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="home.php">RUET Connect</a>
		</div>
					...
					<?php
						...
						<li class='dropdown'>
							...
							<ul class='dropdown-menu'>
								<li>
									<a style='color:blue; '>My Posts <span class='badge badge-secondary'>$posts</span></a>
								</li>
