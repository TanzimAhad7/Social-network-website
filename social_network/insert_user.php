...
include 'includes/connection.php';
    ...
    if (isset($_POST['sign_up'])) {
        ...
        $pass = md5(htmlentities(mysqli_real_escape_string($con, $_POST['u_pass'])));
		...
		values('$first_name','$last_name','$username','','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
