...
function insertPost()
{
    if (isset($_POST['sub'])) {
        ...
        if (strlen($content) > 550) {
            echo "<script>alert('Please Use 250 or less than 550 words!')</script>";
				...
				<div class='row'>
					...
					<div id='posts' class='col-sm-6'>
						<div class='row'>
							...
							<div class='col-sm-6'>
								<h3><a style='text-decoration:none; cursor:pointer;color: #ffffff;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
...
function search_user()
{
    ...
    if (isset($_GET['search_user_btn'])) {
        ...
        $get_user = "select * from users where f_name like '%$search_query%' OR l_name like
		'%$search_query%' OR user_name like '%$search_query%'";
    } else {
    ...
    while ($row_user = mysqli_fetch_array($run_user)) {
        ...
        echo"
		 ...
		 <div class='col-sm-6'>
		 <a style = 'text-decoration:none;cursor:pointer;color:white;'
...
function single_post()
{
    if (isset($_GET['post_id'])) {
        ...
        echo"
		 ...
		 <textarea style='background-color: black; color:white;' placeholder='write your comment here!'
